...
create trigger atualiza_preco_total after insert
on cliente_produto
for each row
begin
	
    update cliente_produto c set total = NEW.quantidade * NEW.preco
    where id_produto = NEW.id_produto and id_cliente;
end //
