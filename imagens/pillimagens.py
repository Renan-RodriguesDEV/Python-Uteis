...
driver.find_element(
    By.XPATH, '//*[@id="identifierId"]').send_keys("renanrodrigues7110")
driver.find_element(
    By.XPATH, '//*[@id="identifierNext"]/div/button/span').click()
driver.find_element(
    By.XPATH, '//*[@id="side"]/div[1]/div/div[2]/div[2]/div/div[1]/p').click()
driver.find_element(
    By.XPATH, '//*[@id="side"]/div[1]/div/div[2]/div[2]/div/div[1]/p').send_keys('renan filho')
press('enter')
driver.find_element(
    By.XPATH, '//*[@id="main"]/footer/div[1]/div/span[2]/div/div[2]/div[1]').send_keys('Ola')
time.sleep(10)
# Fechar o navegador
driver.quit()
